...
const phases = [
  {
    ...
    items: [
      ...
      { text: '8 arcade games built', done: true },
      { text: 'Staking system (5 tiers)', done: true },
      { text: 'NFT achievements & items', done: true },
      { text: 'Governance system', done: true },
  ...
  },
  {
    ...
    items: [
      { text: 'Smart contract audits', done: false },
      { text: 'Marketplace UI & trading', done: false },
      { text: 'Auction system launch', done: false },
      { text: 'Tournament & leaderboards', done: false },
      { text: 'Mobile-optimized games', done: false },
      { text: '10,000 active players', done: false },
    ],
  },
  {
    phase: 'Phase 3',
